...
state = pd.read_feather('../output/state_results_lin')



#%%
# look at median
med = state.groupby(['mrms_lat','mrms_lon']).median()['pred']
med = med.to_xarray()
med_std = state.groupby(['mrms_lat','mrms_lon']).std()['pred']
med_std = med_std.to_xarray()

low = state.groupby(['mrms_lat','mrms_lon']).median()['pred']
low = low.to_xarray()

high = state.groupby(['mrms_lat','mrms_lon']).median()['pred']
high = high.to_xarray()
#%%
...
fig.savefig('../output_figures/resultmap_lin.pdf',
