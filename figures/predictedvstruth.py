...
def predictedvstruth(test_results, plot_name):
       ...
       plt.ylim(test_results['truth'].min(),test_results['truth'].max()+5)
       ...
       fig.savefig("../output/experiments/figures/f06"+plot_name+".png",bbox_inches='tight',dpi=600,transparent=False,facecolor='white')