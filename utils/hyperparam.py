...
param = [
    ...
    # dt
    {'max_depth': randint(1, 20),'min_samples_split':randint(2, 20),'min_samples_leaf':randint(1, 20),'random_state': randint(0,1000)
    ...
    'max_iter': randint(100, 1000),
      'random_state': randint(0,1000)  # Maximum number of iterations
    },
    #Ada
    ...
    'reg_lambda': uniform(0, 1),
      'random_state': randint(0,1000)  # L2 regularization term on weights
    },
    #gbc
    {
